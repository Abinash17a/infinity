...
export default function SignUpModal() {
  ...
  return (
    <>
      <button className='w-full h-[48px] md:w-[88px] md:h-[40px] text-sm  rounded-full bg-white font-bold'
        ...
        <div className='w-full h-full sm:w-[600px] sm:h-fit bg-white sm:rounded-xl '>
          ...
          <form action="" className='pt-10 pb-20 px-4 sm:px-20'>
            ...
            <div className='w-full space-y-5 mb-10'>
              <input type="text" className='w-full h-[54px] border border-gray-200 outline-none ps-3 rounded-[4px] focus:border-[#F4AF01] transition'
                placeholder='Name' />
              ...
              <button className=' bg-[#F4AF01] text-white w-full h-[48px] rounded-full font-bold text-sm hover:bg-[#F4AF01]/90 transition duration-200'>
                Signup
              </button>
